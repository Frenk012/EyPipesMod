package frenk.eypipes.particles.custom;
...
public class RingOfSmokeParticle extends SpriteBillboardParticle {
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
         ...
         */
        public Particle createParticle(DefaultParticleType simpleParticleType, ClientWorld clientWorld, double x, double y, double z, double vel_x, double vel_y, double vel_z) {
