...
public class DryingCategory implements IRecipeCategory<DryingRecipe> {
    ...
    // Use vanilla furnace texture for the arrow animation
    ...
    public DryingCategory(IGuiHelper guiHelper) {
        // Create a blank background with enough space for slots and arrow
        ...
        // Create animated arrow using vanilla furnace texture
        IDrawableStatic staticArrow = guiHelper.createDrawable(FURNACE_TEXTURE, 176, 14, 24, 17);
