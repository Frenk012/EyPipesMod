        ...
        try {
            ...
            if (config.has("animation_settings")) {
                ...
                if (animationSettings.has("position_offsets")) {
                    ...
                    PARTICLE_OFFSET_THIRDVIEW_X = (float) getDoubleOrDefault(offsetSettings, "particle_offset_thirdview_x", 0.4);
                    PARTICLE_OFFSET_THIRDVIEW_Y = (float) getDoubleOrDefault(offsetSettings, "particle_offset_thirdview_y", 0.0);
                    PARTICLE_OFFSET_THIRDVIEW_Z = (float) getDoubleOrDefault(offsetSettings, "particle_offset_thirdview_z", -0.7);
                    EyPipes.LOGGER.info("Loaded third person particle offsets - X: " + PARTICLE_OFFSET_THIRDVIEW_X + ", Y: " + PARTICLE_OFFSET_THIRDVIEW_Y + ", Z: " + PARTICLE_OFFSET_THIRDVIEW_Z);
                }
